            ...
            <table class="add_tab">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="link_name" ng-required="true">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="link_url" class="lg" ng-required="true">
                        </td>
                    </tr>
                    <tr>
                        <th>链接标题：</th>
                    ...
                    <tr>
                        <th>链接排序：</th>
                        <td>
                            <input type="text" class="sm" name="link_order" ng-required="true">
