...
@section('content')
@include('layouts/adminPubHead/crumbs',['tab'=>'添加文章分类'])
<!--结果集标题与导航组件 开始-->
            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="cate_name" ng-required="true">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="sm" name="cate_order" ng-required="true">
