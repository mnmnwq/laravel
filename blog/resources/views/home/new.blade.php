...
<article class="blogs">
  ...
  <div class="index_about">
    ...
    <ul class="infos">
      ...
      <p><img src="{{url('resources/views/home/images/e5e39b1148811261c78b933805d07232.png')}}" alt="分手"></p>
      ...
      <p><img src="{{url('resources/views/home/images/1f8aea2172f6eb987c3de3f7ba474eb1.png')}}" alt="分手"></p>
